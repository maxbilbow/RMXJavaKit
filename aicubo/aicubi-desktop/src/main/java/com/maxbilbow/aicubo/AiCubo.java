...
import click.rmx.engine.actors.AxisGenerator;
import click.rmx.engine.actors.EntityGenerator;
import click.rmx.engine.behaviour.SpriteBehaviour;
import click.rmx.engine.behaviour.ants.AntBehaviour;
...
import static click.rmx.engine.Engine.*;
import static click.rmx.engine.behaviour.Ai.AI_STATE_POSSESSED;
import static click.rmx.engine.behaviour.Ai.GET_AI_STATE;
import static click.rmx.engine.behaviour.ants.AntBehaviour.*;
			...
			public void invoke(long window, int key, int scancode, int action, int mods) {
				if (action == GLFW_RELEASE)
					...
					case GLFW_KEY_ENTER:
						...
						player.transform().rootTransform().setLocalMatrix(t.rootTransform().localMatrix());
						...
						break;
					case GLFW_KEY_I:
						didCauseEvent(CanWalkThroughWalls, mods == GLFW_MOD_SHIFT ? "true" : "false");
						break;
					case GLFW_KEY_F:
						switch (mods) {
						//						case GLFW_MOD_SHIFT:
